...
//       const userId = localStorage.getItem("user"); // Obtener el ID del usuario actual
//       try {
//         const response = await axios.get(`http://localhost:8000/student/${userId}`);
//         console.log("Datos de cursos recibidos:", response.data);
//         setCursos(response.data.map(entry => entry.curso)); // Obtener solo los cursos del usuario
//       } catch (error) {
...
//                         onClick={() => handleCursoClick(curso.curso.ID)}
//                     >
//                         <img
//                             src={curso.curso.imageUrl}
//                             alt={curso.curso.NombreCurso}
...
//                                 <ViewMoreButton onClick={() => handleVerMasClick(curso.curso.ID)} />
//                             </div>

//                             <h4 className="text-l text-black font-semibold text-center">
//                                 Profesor: {curso.curso.Docente}
//                             </h4>
//                         </div>
//                     </div>
//                 ))}
...
//                                 </button>
//                                 <img
//                                     src={cursoSeleccionado.curso.imageUrl}
//                                     alt={cursoSeleccionado.curso.NombreCurso}
...
//                                     {cursoSeleccionado.curso.contenidocurso.TituloMaterial}
//                                 </h3>
//                                 <div className="flex justify-center">
//                                     <h4 className="text-sm text-gray-500">
//                                         {cursoSeleccionado.curso.Duracion}
//                                     </h4>
//                                     <h4 className="text-sm text-gray-500 mr-4 ml-4">
//                                         Nivel:{cursoSeleccionado.curso.contenidocurso.Nivel}
//                                     </h4>
//                                     <h4 className="text-sm text-gray-500 mb-2">
//                                         Tipo de Recurso:{" "}
//                                         {cursoSeleccionado.curso.contenidocurso.TipoRecurso}
//                                     </h4>
//                                 </div>
...
//                                         {" "}
//                                         Opiniones: {cursoSeleccionado.curso.contenidocurso.Opiniones}
//                                     </p>
//                                 </div>
...
//                                     {cursoSeleccionado.curso.contenidocurso.Descripcion}
//                                 </p>
//                                 <span className="font-semibold text-gray-900 mt-3 mb-3">
//                                     Qué aprenderás:
//                                 </span>
//                                 {cursoSeleccionado.curso.contenidocurso && (
//                                     <>
//                                         <p className="text-s text-gray-700 text-justify mb-3">
//                                             {cursoSeleccionado.curso.contenidocurso.Contenido}
//                                         </p>
//                                     </>
//                                 )}
//                             </article>
...
const CardPage = () => {
  ...
  return (
    <div>
      ...
      <p>Descripción: {courseData.contenidocurso.Descripcion}</p>
      <p>Opiniones: {courseData.contenidocurso.Opiniones}</p>
      <p>Nivel: {courseData.contenidocurso.Nivel}</p>
      <p>Aptitudes: {courseData.contenidocurso.Aptitud1}, {courseData.contenidocurso.Aptitud2}, {courseData.contenidocurso.Aptitud3}</p>
    </div>
  );
};
