              ...
              <div className="p-5">
                ...
                <div className="flex justify-center">
                  <button
                    ...
                    onClick={() => handleVerMasClick(curso.ID)}
                  >
            ...
            <section className="flex items-center justify-center min-h-screen">
              ...
              <div className="w-200 bg-white rounded-lg overflow-hidden shadow-xl transform transition-all sm:max-w-lg sm:w-full">
                ...
                <button
                  ...
                  <span className="font-semibold text-gray-900 mt-3 mb-5">Aptitudes tratadas en este curso: </span>
                  <section className="flex w-100 mt-4 mb-4 gap-5 text-center rounded-lg justify-center items-center">
                    <p className="text-xs w-20 text-center bg-blue-100 rounded-lg p-2 text-blue-500">
                      {cursoSeleccionado.contenidocurso.Aptitud1}
                    </p>
                    <p className="text-xs w-20 bg-blue-100 rounded-lg p-2 text-blue-500">
                      {cursoSeleccionado.contenidocurso.Aptitud2}
                    </p>
                    <p className=" flex text-xs w-20 h-10 bg-blue-100 rounded-lg p-2 text-blue-500">
                ...
                <footer className="bg-gray-50 px-4 py-3 sm:px-6 flex justify-center">
                    ...
                    <button className="button-courses w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-500 text-base font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:ml-3 sm:w-auto sm:text-sm">
