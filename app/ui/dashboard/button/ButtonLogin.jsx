...
const ButtonLogin = ({ text, onClick }) => {
  return (
    <button onClick={onClick} className="bg-[#007AFF] text-white hover:bg-[#183579] py-2 px-6 rounded-full text-lg font-semibold transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg">
      {text}
    </button>
  );
}
