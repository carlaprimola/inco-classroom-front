        ...
        <div class="max-w-7xl mx-auto p-4 sm:p-6 lg:p-8">
            <div class="container mx-auto px-6 p-6 bg-white">
                ...
                <div class="mb-16 text-center">
                    <h4 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Inicio</h4>
                    <p class="mt-2 text-5xl lg:text-7xl font-bold tracking-tight text-gray-900">Bienvenido a inco academy
